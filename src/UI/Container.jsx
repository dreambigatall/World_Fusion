  ...
  return (
    <>
      ...
      <div className="bg-stone-800 flex justify-between w-full fixed top-0 left-0 z-20 p-5">
        ...
        <div>
          <button onClick={handelAiClick} className='text-3xl bg-blue-300 rounded-full mx-3'>🧐 
          ...
          <div  >
            <Link to="/quetion">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="37" height="37" color="#111111" fill="none" className='bg-white rounded-full text-3xl mx-3'>
